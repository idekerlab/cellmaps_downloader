...
# -*- coding: utf-8 -*-
#
# cellmaps_downloader documentation build configuration file, created by
...
init_file = os.path.join('..', 'cellmaps_downloader', '__init__.py')
...
htmlhelp_basename = 'cellmaps_downloaderdoc'
...
latex_documents = [
    (master_doc, 'cellmaps_downloader.tex',
     u'cellmaps_downloader Documentation',
     u'Gege Qian', 'manual'),
]
...
man_pages = [
    (master_doc, 'cellmaps_downloader',
     u'cellmaps_downloader Documentation',
     [author], 1)
]
